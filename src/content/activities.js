...
const eventImages = [
  {
    ...
    desktopImgSrc: `${CDN_URL}/activities/activities-container__disco--desktop.jpg`,
    mobileImgSrc: `${CDN_URL}/activities/activities-container__disco--desktop.jpg`
  },
  {
    altText: "Tea party for residents on Mother's Day",
    desktopImgSrc: `${CDN_URL}/activities/activities-container__tea--desktop.jpg`,
    mobileImgSrc: `${CDN_URL}/activities/activities-container__tea--desktop.jpg`
  },
  {
    altText: "Santa visiting the residents during Christmas party",
    desktopImgSrc: `${CDN_URL}/activities/activities-container__santa--desktop.jpg`,
    mobileImgSrc: `${CDN_URL}/activities/activities-container__santa--desktop.jpg`
  }
];
